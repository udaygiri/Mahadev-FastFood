...
export default function BottomNav({ activeTab, onChangeTab, hasActiveOrder }) {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 shadow-lg">
      <div className="max-w-md mx-auto grid grid-cols-3 py-1.5 px-3 gap-1">
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 py-1 rounded-xl transition-all cursor-pointer ${
            activeTab === 'profile' ? 'text-brand-primary font-extrabold bg-red-50/70' : 'text-gray-400 hover:text-gray-600'
          }`}
        >
